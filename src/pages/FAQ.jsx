    ...
    <>
      ...
      <div className="faq-container bg-white">
        ...
        <div className="text-center mt-8">
          <button
            className="bg-tertiary bg-opacity-50 border border-secondary font-secondary font-semibold text-primary py-2 px-6 rounded-xl shadow-lg mb-8 mt-5 inline-flex items-center hover:bg-secondary hover:text-white"
