    ...
    <div className="float-start w-full">
      ...
      <div className="text-white bg-primary">
        <div className="max-w-full mx-9 p-8 rounded-2xl">
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold font-primary text-secondary mb-4">
              Who We Are...
            </h3>
            <p className="text-md font-secondary leading-relaxed">
          ...
          <div className="relative">
            <h3 className="text-xl font-primary font-semibold text-secondary mb-4">
              Why TaskMate?
            </h3>
            <ul className="list-disc pl-5 space-y-2 text-md font-primary ml-14">
              <li className="font-secondary">
                <strong className="font-semibold">
                  Trusted Professionals:
                </strong>{" "}
                All service providers are vetted and reviewed to ensure quality
                and reliability.
              </li>
              <li className="font-secondary">
                <strong className="font-semibold">Easy to Use:</strong>{" "}
                Effortlessly book services and manage appointments from our
                user-friendly platform.
              </li>
              <li className="font-secondary">
                <strong className="font-semibold">Support Local:</strong> By
                using TaskMate, you're supporting skilled professionals from
